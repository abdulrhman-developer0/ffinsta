    ...
    <div class="max-w-lg mx-auto">
        <div class="card p-6">
            ...
            <form method="POST" action="{{ route('admin.orders.store') }}" class="space-y-4"
                ...
                <div x-data="{ mode: '{{ old('custom_username') ? 'custom' : 'existing' }}', customUsername: '{{ old('custom_username') }}' }">
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('imagePicker', () => ({
                ...
                async searchImages() {
                    const usernameVal = document.querySelector('[name="custom_username"]').value;
