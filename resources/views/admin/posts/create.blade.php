    ...
    <div
        ...
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" id="postForm"
                ...
                <div
                    ...
                    <div class="form-group" x-data="{ titleLang: 'en' }">
                        ...
                        <div class="mt-4" x-show="titleLang === 'en'">
                            ...
                            <input type="text" name="slug[en]" value="{{ old('slug.en') }}"
                        ...
                        <div class="mt-4" x-show="titleLang === 'ar'" style="display: none;">
                            ...
                            <input type="text" name="slug[ar]" value="{{ old('slug.ar') }}"
                                class="form-input mt-1 py-2 rounded-xl border-slate-200 dark:border-slate-600 focus:ring-brand-500"
            ...
            <div class="bg-slate-50 dark:bg-slate-800/50 p-4 sm:p-6 lg:p-8 rounded-3xl border border-slate-100 dark:border-slate-700/50 shadow-sm space-y-4 sm:space-y-6"
                ...
                <div class="form-group">
                    ...
                    <input x-show="metaLang === 'en'" type="text" name="meta_title[en]"
                        ...
                        class="form-input rounded-xl border-slate-200 dark:border-slate-600" placeholder="SEO Title">
                    <input x-show="metaLang === 'ar'" style="display: none;" type="text" name="meta_title[ar]"
                ...
                <div class="form-group">
                    ...
                    <textarea x-show="metaLang === 'en'" name="meta_description[en]"
                        ...
                        placeholder="SEO Description">{{ old('meta_description.en') }}</textarea>
                    <textarea x-show="metaLang === 'ar'" style="display: none;" name="meta_description[ar]"
                        ...
                        placeholder="وصف SEO">{{ old('meta_description.ar') }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="meta_header" class="form-input rounded-xl font-mono text-sm border-slate-200 dark:border-slate-600"
                        rows="3" dir="ltr" placeholder="<meta name='custom' content='...'>">{{ old('meta_header') }}</textarea>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-6">
                ...
                <!-- Publish Box -->
                <div
                    class="bg-slate-50 dark:bg-slate-800/50 p-4 sm:p-6 rounded-3xl border border-slate-100 dark:border-slate-700/50 shadow-sm flex flex-col justify-center">
