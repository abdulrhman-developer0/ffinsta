...
@if(config('settings.whatsapp_channel_link'))
    <a href="{{ config('settings.whatsapp_channel_link') }}" target="_blank" rel="noopener noreferrer"
       class="fixed bottom-6 {{ app()->getLocale() === 'ar' ? 'left-6' : 'right-6' }} z-50 flex items-center justify-center w-14 h-14 bg-emerald-500 text-white rounded-full shadow-lg hover:bg-emerald-600 hover:scale-110 transition-all duration-300"
       title="{{ __('Our Official WhatsApp Channel') }}">
